...
# QUANTILE MAPPING  -------------------------------------------------------
# A PARTIR DE AKI VOY A IR SIGUIENDO LO QUE HA HECHO ANDONI EN PRUEBAS_QUANTILE_MATCHING SOBRE TODO PARA COSCARME
...
ggplot(data = DATOS_weibull %>%  filter(month(Date)==2 )) + 
