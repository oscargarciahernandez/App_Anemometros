...
<br />
<br />
Para plotear la línea de temperatura media, tendremos que generar un vector cuyo valor se repita una serie de veces. Para ello usaremos *rep()*, que crear un vector que repite el valor de x, tantas veces le indiquemos. 
<br />
<br />
